...
* You may not *attempt* to use any unauthorized assistance on exams. Note that even if your attempt is unsuccessful (e.g. you open ChatGPT on an exam but are "caught" before you can copy and paste a question into it), you will earn a zero grade on the exam and a record in the Office of Student Life and Services. 
...
In this course, the learning objective is to develop the mental models of machine learning. Doing computations and writing code yourself helps you develop that mental model; letting an LLM do it bypasses the cognitive work the course is designed to develop. So, in Intro ML, I don't allow AI use, except for in very specific instances (see below).

First, here is some free advice on generative AI and *human* learning:

The sequence of assignments in this course is calibrated for human learners, to gradually learn the content by progressively building on what they have already mastered. 

* If you do the homework problem sets and lab assignments yourself (*especially* if you find them challenging!), you are "exercising" your brain in ways that make your abilities stronger, and prepare you to attempt more difficult problems (including more difficult problems that you might tackle in collaboration with an AI coding agent, and where your subject matter expertise will help you be more effective in that collaboration). 
* If you use AI extensively to offload tasks that are intended to "exercise" your brain, like homework problem sets and lab assignments, you will instead experience [cognitive atrophy](https://spencerauthor.com/cognitive-atrophy/) - your cognitive ability (as it relates to the skills in this couse) gets weaker, instead of stronger. You will likely find yourself unprepared for some of the problems on the proctored exams, where you are not allowed to use AI, and possibly for applications of this course material further down the line (e.g. job interviews, internships).
...
Retrieval practice is like going to the gym. It's not most people's favorite activity because it requires effort and time, and is often uncomfortable, but it is necessary for growing and learning. (By the way, retrieval practice - much more so than re-reading - has been shown to create memories that are more resistant to stress e.g. the stress of an exam setting, or a job interview.)

With all that in mind, in this class, you are encouraged to use AI assistance for the following tasks:
...
* to generate Python code on questions where an AI coding agent (we'll use `opencode`) is explicitly integrated into the question environment, and the instructions tell you to use this AI coding agens.
...
Are there ways to use AI that will cause less "cognitive atrophy" than other ways? Yes, here are some suggestions specifically for coding problems - 
