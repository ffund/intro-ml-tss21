...
Your overall numeric course grade is determined as follows:
...
* 2 sheets of 8.5x11 inch-sheet double sided (i.e. 4-page) reference that you have prepared, with whatever you think you will find useful. This reference sheet must be printed or handwritten - you may not use a digital copy. <!-- At the end of your exam, you will submit a photo of your reference sheet along with your exam. -->
...
There will be an optional opportunity to re-attempt the midterm exam (with new questions). This opportunity is available only to students who took the first midterm exam. If you re-attempt the exam, your second score will count, whether it is higher or lower than your first score.
...
<table style="width:100%; table-layout:fixed;">
  ...
  <tbody>
    ...
    <tr>
      <td>Colab lecture</td>
      <td>0.5 points per lecture</td>
      <td>Answer <strong>all questions</strong> in Colab videos within <strong>1 week</strong>; those marked with “✅” must be answered correctly.</td>
    </tr>
    <tr>
